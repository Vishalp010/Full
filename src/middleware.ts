...
// See "Matching Paths" below to learn more is part me hum ye likhte h ki hmaara middle ware kis path pr run krega ki kis route se match krna h and middleware run krna h 
export const config = {
  matcher: [
    '/',
    '/profile',
